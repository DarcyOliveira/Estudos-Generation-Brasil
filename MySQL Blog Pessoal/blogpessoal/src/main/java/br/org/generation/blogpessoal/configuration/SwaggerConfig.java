...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		...
		return new ApiInfoBuilder()
			.title("Mystical Panda Library")
			.description("Uma biblioteca onde livros ganham vida.")
			.version("1.0.0")
			.license("Apache License Version 2.0")
			.licenseUrl("https://github.com/DarcyOliveira")
			.contact(contact())
			.build();
	}
	...
	private static Contact contact() {
		...
		return new Contact("Darcy Oliveira", 
			"https://github.com/DarcyOliveira", 
			"darcyelleoliveira@gmail.com");
